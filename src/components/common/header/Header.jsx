                            ...
                            <ul className="flex md:gap-6">
                                {
                                    ...
                                    header_data.map( ( item, index ) => {
                                        ...
                                        return (
                                            <li key={ index } className={` ${ activePage === item.data.title ? "border-saritasa_primary" : "border-transparent" } pb-1 border-b-2 text-base text-slate-500 font-avenir font-semibold uppercase flex items-center gap-2 relative group cursor-pointer`} onClick={() => setActivePage( item.data.title )}>
